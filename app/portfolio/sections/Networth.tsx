  ...
  return (
    <div >
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 gap-x-5 gap-y-5">
        <div className="rounded-md border-2 shadow-lg backdrop-blur-lg bg-white/30 px-4 py-2 overflow-y-scroll">
          <h1 className="text-[#4169e1] font-semibold mb-4 text-2xl ">
            {" "}
        ...
        <div className="rounded-md border-2 shadow-lg backdrop-blur-lg bg-white/30 px-4 py-2">
          <h1 className="text-[#4169e1] font-semibold mb-4 text-2xl">
            {" "}
            Stocks
          </h1>
        ...
        <div className="rounded-md border-2 shadow-lg backdrop-blur-lg bg-white/30 px-4 py-2">
          ...
          <h1 className="text- green-text font-extrabold text-3xl">
            ₹ {data.remainingCash}
          </h1>
        </div>
        <div className="py-4 rounded-lg shadow-lg backdrop-blur-lg bg-white/30 px-4 border-2">
          <h1 className="blue-text font-semibold mb-4 text-2xl"> Holdings </h1>{" "}
          <HoldingTable
            profitData={
        ...
        <div className="p-5 border-2 shadow-lg backdrop-blur-lg bg-white/30 rounded-lg">
          <h1 className="blue-text font-semibold mb-4 text-2xl">
            {" "}
            Holding Chart{" "}
          </h1>{" "}
        ...
        <div className="rounded-md border-2 shadow-lg backdrop-blur-lg bg-white/30 p-5">
          <h1 className="blue-text font-semibold mb-4 text-2xl">
            {" "}
            Order Book{" "}
          </h1>{" "}
          ...
          <h1
            className={`text-right my-2 blue-text underline font-semibold ${data.orderBook?.length === 0 ? "hidden" : "block"} `}
          >
