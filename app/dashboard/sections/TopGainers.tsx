    ...
    <div>
      <div className="mt-1 mb-2">
        <button
          ...
          className={` ${buttonClass} ${display === "LARGECAP" ? "bg-[#4169e1] text-white" : "bg-white border-[1px] border-[#696969]"}  `}
        >
          Large
        </button>
        <button
          ...
          className={` ${buttonClass} ${display === "MIDCAP" ? "bg-[#4169e1] text-white" : "bg-white border-[1px] border-[#696969]"}  `}
        >
          Mid
        </button>
        <button
          ...
          className={` ${buttonClass} ${display === "SMALLCAP" ? "bg-[#4169e1] text-white" : "bg-white border-[1px] border-[#696969]"}  `}
        >
          Small
        </button>
      </div>
