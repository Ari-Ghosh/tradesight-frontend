...
export default function HighChart(props: any) {
  ...
  useEffect(() => {
    async function getDailyCandlesData() {
      let data;
      console.log("symbol", btoa(symbol));
      try {
    ...
    <div>
      <div>
        ...
        <div className="flex text-sm flex-row justify-center">
          <button
            className={`p-1  px-3 mx-2  rounded-2xl ${display == "DAILY"
          ...
          <button
            className={`p-1 px-3 mx-2  rounded-2xl ${display == "WEEKLY"
              ? "bg-white text-black border border-1 border-[#037a68]"
              : "border border-1 border-[#858585]"
              } `}
          ...
          <button
            className={`p-1 px-3 mx-2  rounded-2xl ${display == "MONTHLY"
              ? "bg-white text-black border border-1 border-[#037a68]"
              : "border border-1 border-[#858585]"
              } `}
          ...
          <button
            className={`p-1 px-3 mx-2  rounded-2xl ${display == "YEARLY"
              ? "bg-white text-black border border-1 border-[#037a68]"
              : "border border-1 border-[#858585]"
              } `}
